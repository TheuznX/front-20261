  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', fontFamily: 'Arial, sans-serif', backgroundColor: '#fff' }}>
      <div style={{ width: '340px', border: '1px solid #e0e0e0', padding: '40px 30px', borderRadius: '8px', backgroundColor: '#fff' }}>
        ...
        <h2 style={{ fontSize: '26px', fontWeight: 'bold', color: '#000', marginBottom: '30px', textAlign: 'center' }}>
          Login - Aluno Online
        </h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div style={{ marginBottom: '20px' }}>
            <label style={{ display: 'block', fontSize: '15px', color: '#000', marginBottom: '8px', fontWeight: 'bold' }}>
              E-mail
            </label>
            <input
              type="text"
            ...
            />
            {errors.email && (
              <p style={{ color: '#cc0000', fontSize: '14px', margin: '6px 0 0 0', fontWeight: '500' }}>
          ...
          <button
            type="submit"
            style={{ width: '100%', padding: '10px', fontSize: '16px', backgroundColor: '#efefef', color: '#000', border: '1px solid #767676', borderRadius: '4px', cursor: 'pointer', fontWeight: 'bold' }}
          >
            Entrar
          </button>
